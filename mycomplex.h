...
public:
    // Конструктор с возможностью задать значения частей комплексного числа
    ...
    // Метод для установки значений частей
    void Set(double aRe, double aIm = 0);

    // Оператор преобразования в double (например, для получения длины вектора)
    operator double();
